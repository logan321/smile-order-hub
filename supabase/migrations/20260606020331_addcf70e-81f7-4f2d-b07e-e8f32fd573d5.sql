-- Create uv_color_mappings table
CREATE TABLE public.uv_color_mappings (
    id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
    uv_map_id UUID NOT NULL REFERENCES public.uv_maps(id) ON DELETE CASCADE,
...
CREATE TRIGGER update_uv_color_mappings_updated_at
    ...
    FOR EACH ROW
    EXECUTE FUNCTION public.update_uv_color_mappings_updated_at();

-- Drop old tables
DROP TABLE IF EXISTS public.template_color_mappings;
DROP TABLE IF EXISTS public.stamp_color_mappings;
